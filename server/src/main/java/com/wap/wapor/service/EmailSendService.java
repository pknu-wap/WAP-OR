    ...
    public String requestAuthCode(String identifier) {
        ...
        String content =
                "<div style='font-family: Arial, sans-serif; max-width: 900px; margin: 0 auto; border-radius: 10px; overflow: hidden;'>" +
                        ...
                        "<img src='http://34.47.73.194:8080/images/icon.png' alt='앱 로고' style='height: 60px; width: auto; max-width: 100%;'>" +
                        "</div>" +
                        // 본문 내용
                        ...
                        "안녕하세요, <img src='http://34.47.73.194:8080/images/logo.png' alt='와포어 로고' style='height: 24px; width: auto; vertical-align: middle;'>입니다.<br>" +
